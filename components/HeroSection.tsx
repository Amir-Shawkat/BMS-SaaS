            ...
            <div className="library-hero-card">
                <div className="library-hero-content">
                    ...
                    <div className="library-hero-text">
                        ...
                        <Link href="/books/new" className="library-cta-primary mt-4 flex items-center justify-center w-max">
                    ...
                    <div className="library-hero-illustration-desktop">
                        <Image src="/assets/hero-illustration.png" alt="Vintage books and globe" width={400} height={400} className="object-contain" />
                    </div>

                    {/* Center Part Mobile hidden on desktop */}

                    <div className="library-hero-illustration">
                        <Image src="/assets/hero-illustration.png" alt="Vintage books and globe" width={300} height={300} className="object-contain" />
                    </div>
